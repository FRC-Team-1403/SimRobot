...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // Elevator Controls
    new Trigger(() -> m_keyboard.getAButton())
        .onTrue(new RunCommand(() -> m_elevator.reachGoal(Constants.kSetpointMeters), m_elevator))
        .onFalse(new InstantCommand(() -> m_elevator.stop(), m_elevator));
    // Arm Controls
  ...
  public Command getAutonomousCommand() {
    ...
    return Autos.exampleAuto(m_drive, m_timer);
  }

  // This Code Runs ONCE when the robot is disabled
  ...
  // This Code Runs ONCE when the robot is in teleop
